   ...
   if(isset ($_POST['submit']))
	...
	$pwd=mysqli_real_escape_string($conn,$_POST['pwd']);
		...
		if( empty($first) || empty($last) || empty($uid) || empty($pwd) )
		{
			...
			$sql="SELECT * FROM syste_user Where uid='$uid' ";
		...
		" ;
					...
					//Inserting Into Data Base 
						...
						$sql= "INSERT INTO syste_user (first,last,uid,pwd) VALUES ('$first','$last','$uid','$hashedpwd')" ;
		...
		{
			header("Location: signup.php?signup=wrong");
			 EXIT ();
		}
?>
